...
public class OrderHamburger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_hamburger);
        ...
        toFoodsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(OrderHamburger.this, FoodsActivity.class));
            }
        });
        ...
        toUserOrderBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(OrderHamburger.this, UserOrderActivity.class));
            }
        });
    }
}